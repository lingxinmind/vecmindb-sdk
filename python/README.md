...
The official Python SDK for [VecminDB](https://lingxinmind.com) — the self-hosted memory layer for your AI coding agents.

`pip install vecmindb` · `pip install vecmindb[langchain]` · `pip install vecmindb[crewai]`
